// warehouse module
export const api_warehouse_add = "post:/wms/basic/warehouseMainData/createOrUpdate";
export const api_warehouse_update = "post:/wms/basic/warehouseMainData/createOrUpdate";
...
export const api_batch_attribute_add = "post:/wms/config/batchAttributeConfig/createOrUpdate"
export const api_batch_attribute_update = "post:/wms/config/batchAttributeConfig/createOrUpdate"
export const api_batch_attribute_get = "post:/wms/config/batchAttributeConfig/${id}"
